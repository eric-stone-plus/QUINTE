...
def validate_manifest(manifest: Any) -> list[str]:
    ...
    if manifest.get("dispatch_manifest_version") != "1.0":
        errors.append("dispatch_manifest_version must be 1.0")
...
def validate_ledger(ledger: Any) -> list[str]:
    ...
    if ledger.get("dispatch_ledger_version") != "1.0":
        errors.append("dispatch_ledger_version must be 1.0")
