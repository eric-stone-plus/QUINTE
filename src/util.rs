...
mod tests {
    ...
    fn read_json_distinguishes_syntax_errors_from_schema_mismatches() {
        ...
        // Syntax error: report syntax, with serde line/column info in the chain
        ...
        // Syntactically valid but schema-mismatched: report schema, with serde field-level cause
        ...
        // Unknown fields also land in the schema tier (deny_unknown_fields)
