...
/// Finance uses simultaneous additive writers. These constants never replace
/// the generic writer constants above.
pub const FINANCE_PROTOCOL_VERSION: &str = "2.0";
pub const FINANCE_POLICY_VERSION: &str = "3.0";
pub const FINANCE_RUN_MANIFEST_VERSION: &str = "3.0";
pub const FINANCE_TASK_PACKET_VERSION: &str = "2.0";
pub const FINANCE_R2_PACKET_VERSION: &str = "2.0";
pub const SCHOOL_LANE_OUTPUT_VERSION: &str = "1.0";
pub const FINANCE_REVIEW_RESULT_VERSION: &str = "1.0";
...
pub const FINANCE_POLICY_SCHEMA: &str = include_str!("../schemas/policy-3.0.schema.json");
pub const FINANCE_TASK_PACKET_SCHEMA: &str = include_str!("../schemas/task-packet-2.0.schema.json");
pub const FINANCE_R2_PACKET_SCHEMA: &str = include_str!("../schemas/r2-packet-2.0.schema.json");
pub const FINANCE_RUN_MANIFEST_SCHEMA: &str =
    include_str!("../schemas/run-manifest-3.0.schema.json");
pub const SCHOOL_LANE_OUTPUT_SCHEMA: &str =
    include_str!("../schemas/school-lane-output.schema.json");
pub const FINANCE_REVIEW_RESULT_SCHEMA: &str =
    include_str!("../schemas/finance-review-result.schema.json");
pub const FINANCE_ARBITER_VERDICT_SCHEMA: &str =
    include_str!("../schemas/finance-arbiter-verdict.schema.json");
pub const FINANCE_RUN_EVENT_SCHEMA: &str = include_str!("../schemas/run-event-2.0.schema.json");
pub const FINANCE_PENDING_TRANSITION_SCHEMA: &str =
    include_str!("../schemas/pending-transition-2.0.schema.json");
pub const AUXILIARY_SCHEMA_DOCUMENTS: &[&str] = &[
    FINANCE_POLICY_SCHEMA,
    FINANCE_TASK_PACKET_SCHEMA,
    FINANCE_R2_PACKET_SCHEMA,
    FINANCE_RUN_MANIFEST_SCHEMA,
    SCHOOL_LANE_OUTPUT_SCHEMA,
    FINANCE_REVIEW_RESULT_SCHEMA,
    FINANCE_ARBITER_VERDICT_SCHEMA,
    FINANCE_RUN_EVENT_SCHEMA,
    FINANCE_PENDING_TRANSITION_SCHEMA,
];
...
pub fn writer_version(capability: WriterCapability, family: &str) -> Option<&'static str> {
    match (capability, family) {
        (WriterCapability::GenericWritable, "protocol") => Some(PROTOCOL_VERSION),
        (WriterCapability::GenericWritable, "policy") => Some(POLICY_VERSION),
        (WriterCapability::GenericWritable, "run_manifest") => Some(RUN_MANIFEST_VERSION),
        (WriterCapability::GenericWritable, "task_packet") => Some(TASK_PACKET_VERSION),
        (WriterCapability::GenericWritable, "r2_packet") => Some(R2_PACKET_VERSION),
        (WriterCapability::GenericWritable, "result") => Some(RESULT_VERSION),
        (WriterCapability::FinanceWritable, "protocol") => Some(FINANCE_PROTOCOL_VERSION),
        (WriterCapability::FinanceWritable, "policy") => Some(FINANCE_POLICY_VERSION),
        (WriterCapability::FinanceWritable, "run_manifest") => Some(FINANCE_RUN_MANIFEST_VERSION),
        (WriterCapability::FinanceWritable, "task_packet") => Some(FINANCE_TASK_PACKET_VERSION),
        (WriterCapability::FinanceWritable, "r2_packet") => Some(FINANCE_R2_PACKET_VERSION),
        (WriterCapability::FinanceWritable, "school_lane_output") => {
            Some(SCHOOL_LANE_OUTPUT_VERSION)
        }
        (WriterCapability::FinanceWritable, "finance_review_result") => {
            Some(FINANCE_REVIEW_RESULT_VERSION)
        }
        _ => None,
    }
}
