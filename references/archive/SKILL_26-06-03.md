...
> **⚠️ This standalone skill has been absorbed into `multi-agent-debate` as of 26-06-03.**
...
- **26-06-03 v2.2**: hm/rx shorthands added, rx R1 prohibition, execution discipline
- **26-06-03 v2.1**: OMP promoted from hot spare to full R1 participant. Architecture: R1=4 agents, R2=5.
- **26-06-03 v2.0**: Skill absorbed into `multi-agent-debate`. `oh-my-pi` → `OMP` naming standardized. No-degradation policy.
